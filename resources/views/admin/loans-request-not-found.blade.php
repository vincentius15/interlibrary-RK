        ...
        <main class="hoc container clear">
            ...
            <div class="content">
                ...
                {{--<div class="group btmspace-20 demo">--}}
                    ...
                    <br>
                    <br>
                    <h3 style="text-align: center">Permohonan peminjaman atas nama <strong>{{session('name')}}</strong> tidak ditemukan</h3>
                    <p style="text-align: center"><a href="/admin/loans-request">Kembali ke Daftar Permohonan Peminjaman</a></p>
                {{--</div>--}}
            </div>
            <!-- ################################################################################################ -->
            <!-- / main body -->
