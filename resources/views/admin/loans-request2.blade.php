        ...
        <main class="hoc container clear">
            ...
            <div class="content">
                ...
                <nav class="pagination">
                    <ul>
                        <li><a href="/admin/loans-request">&laquo; Previous</a></li>
                        <li><a href="/admin/loans-request">1</a></li>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <strong><p style="text-align: center">Nama Buku</p></strong><br>
                        <p style="text-align: center">Oleh</p>
                        <strong><p style="text-align: center">Nama Peminjam</p></strong>
                    </div>
