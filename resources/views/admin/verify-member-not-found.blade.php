        ...
        <main class="hoc container clear">
            ...
            <div class="content">
                ...
                {{--<div class="group btmspace-20 demo">--}}
                    ...
                    <br>
                    <br>
                    <h3 style="text-align: center">Permintaan atas nama <strong>{{session('name')}}</strong> tidak ditemukan</h3>
                    <p style="text-align: center"><a href="/admin/verify-member">Kembali ke Daftar Permintaan Anggota</a></p>
                {{--</div>--}}
            </div>
            <!-- ################################################################################################ -->
            <!-- / main body -->
