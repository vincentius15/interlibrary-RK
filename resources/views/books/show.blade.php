            ...
            <div class="content">
                ...
                <div class="group btmspace-20 show-content">
                    ...
                    <div class="col-lg-3 row" style="margin: 30px 0px;">
                        <a data-toggle="modal" data-target="#ajukan-peminjaman" class="btn btn-blue" href="#">Ajukan Peminjaman</a>
                        <p class="topspace-20">Lokasi :<br><strong>Departemen Informatika</strong></p>
                    </div>
                </div>
            </div>
        </main>
        <div id="ajukan-peminjaman" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="text-align: center">Apakah anda yakin ingin meminjam buku :</p><br>
                        <strong><p style="text-align: center">Nama buku</p></strong>
                    </div>
