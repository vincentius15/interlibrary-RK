            ...
            <div class="content">
                ...
                {{--<div class="group btmspace-20 demo">--}}
                    {{--<div class="full first">--}}
                        ...
                        {{--<div class="book-description-medium">--}}
                            ...
                            {{--<p class="topspace-5 btmspace-5">Arya Wiranata</p>--}}
                            {{--<p class="topspace-5 btmspace-5">ITS Press</p>--}}
                            {{--<p class="topspace-5 btmspace-5">12321</p>--}}
                        {{--</div>--}}
                ...
                {{--<div class="group btmspace-20 demo">--}}
                    {{--<div class="full first">--}}
                        ...
                        {{--</div>--}}
                        {{--<div class="book-description-medium">--}}
                            {{--<h6 class="topspace-5 btmspace-15">Ternak Lele di Kostan</h6>--}}
                            {{--<p class="topspace-5 btmspace-5">Wembo Dumbo</p>--}}
                            {{--<p class="topspace-5 btmspace-5">ITS Press</p>--}}
                            {{--<p class="topspace-5 btmspace-5">12322</p>--}}
                        {{--</div>--}}
                        {{--<div class="control-button rightspace-10 float-left">--}}
                          {{--<p class="topspace--10 btmspace-5">Status :</p>--}}
                ...
                <div class="group btmspace-20 demo">
                    <div class="full first">
                        ...
                        <div class="book-description-medium">
                            <h6 class="topspace-5 btmspace-15">Misteri Jubah Kyuubi</h6>
                            <p class="topspace-5 btmspace-5">Icad Bobby</p>
                            <p class="topspace-5 btmspace-5">ITS Press</p>
                            <p class="topspace-5 btmspace-5">12323</p>
                        </div>
                        <div class="control-button rightspace-10 float-left">
                          <p class="topspace--10 btmspace-5">Status :</p>
